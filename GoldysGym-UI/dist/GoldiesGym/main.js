...
var environment = {
    ...
    // AUTH_API : 'http://localhost:9000/user-service/api/v1/userservice',
    //   AUTH_LOGIN_API : 'http://localhost:9000/user-service/api/v1/userservice/login',
    // ADMIN_API_URL:'http://localhost:9000/gym-service/api/v1/gymservice',
    // USER_BOARD_API_URL:'http://localhost:9000/gym-service/api/v1/gymservice',
    // USER_QUERY_API_URL:'http://localhost:9000/enquiry-service/api/v1/enquiryservice/admin/',
    // USER_TICKET_API: 'http://localhost:9000/ticket-service/api/v1/ticketservice',
...
module.exports = __webpack_require__(/*! /Users/somsubhramukherjee/somsubhra/StackRoute/CTS Micro-Credential - Spring - Assignment/Goldys Gym - Final/Step-2/goldys-gym/src/main.ts */"./src/main.ts");
